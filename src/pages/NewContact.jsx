...
function NewContact(props) {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post(`${API_URL}/contacts`, requestBody)
      ...
      .then(() => {
        axios.put(`${API_URL}/contacts/${contact}&${user._id}`)
        .then((response) =>{
            ...
            <div className="relative bg-white shadow-xl">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3">
                ...
                <div className="relative overflow-hidden bg-gradient-to-b from-teal-500 to-teal-600 py-10 px-6 sm:px-10 xl:p-12">
                  ...
                  Add a new contact, don't forget to add all your information.
                  </p>
